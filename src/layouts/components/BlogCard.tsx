...
import { humanize, slugify, plainifyWithLineBreaks } from "@/lib/utils/textConverter";
...
const BlogCard = ({ data }: { data: Post }) => {
  ...
  return (
    <div className="bg-body dark:bg-darkmode-body">
      ...
      <p className="mb-6">
        {description ? description : plainifyWithLineBreaks(data.content, Number(summary_length))}
      </p>
      <Link
