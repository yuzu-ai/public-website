...
<!-- {% image "./src/posts/2023-06-25-rakuda-benchmark/lmsys_leaderboard.png" , "A ranking of AI assistants from https://chat.lmsys.org/?leaderboard"  %} -->
...
$$ \textrm{Likelihood}(\alpha, \vec{\beta}) = \prod_{\textrm{matches}} p_{ij}^Y \times (1-p_{ij})^{1-Y} $$
